...
if (!class_exists('Install')) {
	...
	final class Install
	{
		...
		public function text_domain_cb()
		{
			...
			load_textdomain($this->text_domain, AI_PLUGIN_TRANSLATE . 'textdomain-' . $locale . '.mo');
			load_plugin_textdomain($this->text_domain, false, AI_PLUGIN_TRANSLATE);
		}
